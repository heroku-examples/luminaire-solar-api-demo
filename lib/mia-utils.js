        ...
        if (toolCall) {
          try {
            ...
            if (/^html_to_markdown/.test(functionName)) {
              ...
              return { role: 'tool', content: 'Executing Ruby code...' };
            } else if (
              /^code_exec_python|^mcp\/code_exec_python/.test(functionName)
            ) {
              return { role: 'tool', content: `Executing Python code...` };
            } else if (/^code_exec_node/.test(functionName)) {
              return { role: 'tool', content: 'Executing Node.js code...' };
              ...
              return { role: 'tool', content: 'Querying the database...' };
            ...
            return { role: 'tool', content: 'Processing tool response...' };
          }
        } else {
          return {
            role: 'assistant',
