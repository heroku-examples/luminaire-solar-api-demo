...
declare module 'lightning/uiRelatedListApi' {
   ...
   */
  export function getRelatedListsInfo(
    parentObjectApiName?: string | ObjectId
  ): void;
...
declare module 'lightning/analyticsWaveApi' {
  ...
  export interface AssetReferenceRepresentation
    extends BaseAssetReferenceRepresentation {}
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  export interface AssetReferenceInputRepresentation
   ...
   *    (none)
   */
  export interface DailyScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    (none)
   */
  export interface DataConnectorInputRepresentation
    extends BaseAssetInputRepresentation {
   ...
   *    id (string): id
   */
  export interface DataConnectorRepresentation
    extends BaseWaveAssetRepresentation {
   ...
   *    id (string): id
   */
  export interface DataflowJobRepresentation
    extends BaseWaveAssetRepresentation {
   ...
   *    (none)
   */
  export interface DatasetInputRepresentation
    extends BaseAssetInputRepresentation {
    /** Type of the dataset */
    datasetType?: string;
   ...
   *    id (string): id
   */
  export interface DatasetVersionRepresentation
    extends BaseWaveAssetRepresentation {
   ...
   *    (none)
   */
  export interface EventBasedScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    id (string): assetId
   */
  export interface EventDrivenScheduleRepresentation
    extends ScheduleRepresentation {
    frequency: 'eventdriven' | 'EventDriven';
  }
   ...
   *    (none)
   */
  export interface HourlyScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    (none)
   */
  export interface MinutelyScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    id (string): assetId
   */
  export interface MinutelyScheduleRepresentation
    extends ScheduleRepresentation {
    frequency: 'minutely' | 'Minutely';
    /** Days of the week on which the schedule will run. */
    daysOfWeek: Array<string>;
   ...
   *    (none)
   */
  export interface MonthlyRelativeScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    id (string): assetId
   */
  export interface MonthlyRelativeScheduleRepresentation
    extends ScheduleRepresentation {
    frequency: 'monthlyrelative' | 'MonthlyRelative';
    /** Day within a week. */
    dayInWeek: string;
   ...
   *    (none)
   */
  export interface MonthlySpecificScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    id (string): assetId
   */
  export interface MonthlySpecificScheduleRepresentation
    extends ScheduleRepresentation {
    frequency: 'monthly' | 'Monthly';
    /** Days of the month on which the schedule will run (-1, 1-31). Note that months lacking specific days will skip the job. Can specify a single value of -1 to indicate the last day of the month (-1 cannot be used with additional days). */
    daysOfMonth: Array<number>;
   ...
   *    (none)
   */
  export interface ReplicatedFieldRepresentation
    extends AbstractFieldRepresentation {
    skipped: boolean;
   ...
   *    (none)
   */
  export interface WeeklyScheduleInputRepresentation
    extends ScheduleInputRepresentation {
   ...
   *    (none)
   */
  export interface XmdBaseDimensionCustomActionInputRepresentation
    extends XmdBaseDimensionActionInputRepresentation {
    /** icon for the action. */
    icon?: string;
   ...
   *    (none)
   */
  export interface XmdDerivedDimensionInputRepresentation
    extends XmdBaseDimensionInputRepresentation {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  export interface XmdDerivedDimensionMemberInputRepresentation
    extends XmdBaseDimensionMemberInputRepresentation {}
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  export interface XmdDerivedDimensionSalesforceActionInputRepresentation
    extends XmdBaseDimensionActionInputRepresentation {}
   ...
   *    (none)
   */
  export interface XmdDerivedMeasureInputRepresentation
    extends XmdBaseMeasureInputRepresentation {
   ...
   *    (none)
   */
  export interface XmdDimensionCustomActionRepresentation
    extends XmdDimensionBaseActionRepresentation {
    /** icon for the action. */
    icon?: string;
    /** method for the action. */
    method?: string;
   ...
   *    (none)
   */
  export interface XmdDimensionInputRepresentation
    extends XmdBaseDimensionInputRepresentation {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  export interface XmdDimensionMemberInputRepresentation
    extends XmdBaseDimensionMemberInputRepresentation {}
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  export interface XmdDimensionSalesforceActionInputRepresentation
    extends XmdBaseDimensionActionInputRepresentation {}
   ...
   */
  // eslint-disable-next-line @typescript-eslint/no-empty-interface
  export interface XmdDimensionSalesforceActionRepresentation
    extends XmdDimensionBaseActionRepresentation {}
   ...
   *    (none)
   */
  export interface XmdMeasureInputRepresentation
    extends XmdBaseMeasureInputRepresentation {
   ...
   * @param templateIdOrApiName The ID or developer name of the template.
   */
  export function getWaveTemplateReleaseNotes(
    templateIdOrApiName: string
  ): void;
